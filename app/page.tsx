...
export default function HomePage() {
  ...
  const checkUserStrengths = async () => {
    try {
      ...
      const { data: serverStrengths, hasProfile, error: serverError } = await getUserStrengths(deviceId)
      ...
      // Check if there was a database error (not just no data)
      if (serverError && serverError !== "Database not available") {
        console.log("[v0] Database error, falling back to localStorage:", serverError)
        setDatabaseError(true)
      }

      // Fallback to localStorage if we have saved data
      ...
      console.log("[v0] No strengths found, redirecting to onboarding")
      setTimeout(() => {
        router.push("/onboarding")
      }, 100)
      return
      ...
      if (savedStrengths && onboardingCompleted) {
        ...
        setUserStrengths(formattedStrengths)
        // Only set database error if it's a real database connection issue
        ...
        console.log("[v0] No localStorage data, redirecting to onboarding")
        setTimeout(() => {
          router.push("/onboarding")
        }, 100)
        return
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground text-balance leading-relaxed">
                ...
                moment each day to invest in yourself. This is your anti-burnout antidote.
              </p>
            </div>
